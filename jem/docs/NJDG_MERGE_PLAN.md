...
| `drat` | `drat` | — | **no YAML — skip** |
| `drp_income_tax` | `drp_income_tax` | — | **no YAML — skip** |
| `drt` | `drt` | — | **no YAML — skip** |
...
| `hc_guwahati` | `hc_guwahati` | — | **no YAML — skip** |
...
| `iiac` | `iiac` | — | **no YAML — skip** |
| `insurance_ombudsman` | `insurance_ombudsman` | — | **no YAML — skip** |
| `irdai` | `irdai` | — | **no YAML — skip** |
| `itat` | `itat` | — | **no YAML — skip** |
...
| `ministry_consumer_affairs` | `ministry_consumer_affairs` | — | **no YAML — skip** |
| `ministry_corporate_affairs` | `ministry_corporate_affairs` | — | **no YAML — skip** |
| `ministry_defence` | `ministry_defence` | — | **no YAML — skip** |
| `ministry_environment` | `ministry_environment` | — | **no YAML — skip** |
...
| `nclat` | `nclat` | — | **no YAML — skip** |
| `nclt` | `nclt` | — | **no YAML — skip** |
| `ne_lokayuktas_absent` | `ne_lokayuktas_absent` | — | **no YAML — skip** |
| `ngt` | `ngt` | — | **no YAML — skip** |
...
| `sat` | `sat` | — | **no YAML — skip** |
| `sebi` | `sebi` | — | **no YAML — skip** |
...
| `trai` | `trai` | — | **no YAML — skip** |

## Summary
- Mergeable (YAML exists): **115**
