...
Generated by `merge_njdg_snapshot.py --plan`. Re-running the script overwrites this file.

- Snapshot: `path/to/your/njdg-snapshot/graph.json` (local, do not commit)
- Entities with `_detail.case_volume` in the snapshot: 216

## Per entity
| Snapshot id | Target id | YAML | Action |
|---|---|---|---|
| `advocate_general_generic` | `advocate_general_generic` | none | no YAML, skip |
...
| `asgs_india` | `asgs_india` | none | no YAML, skip |
| `atfe` | `atfe` | none | no YAML, skip |
| `attorney_general_india` | `attorney_general_india` | none | no YAML, skip |
| `banking_ombudsman` | `banking_ombudsman` | none | no YAML, skip |
| `bar_council_india` | `bar_council_india` | none | no YAML, skip |
| `board_of_revenue_generic` | `board_of_revenue_generic` | none | no YAML, skip |
| `br_rera` | `br_rera` | none | no YAML, skip |
...
| `civil_judge_generic` | `civil_judge_generic` | none | no YAML, skip |
| `collegium_sc` | `collegium_sc` | `data/entities/_generated/backbone/collegium_sc.yaml` | merge case_volume |
| `commercial_court_generic` | `commercial_court_generic` | none | no YAML, skip |
| `court_marshal_sc` | `court_marshal_sc` | none | no YAML, skip |
| `crpf` | `crpf` | none | no YAML, skip |
...
| `district_cdrc_generic` | `district_cdrc_generic` | none | no YAML, skip |
| `district_sessions_court_generic` | `district_sessions_court_generic` | none | no YAML, skip |
| `dl_advocate_general` | `dl_advocate_general` | `data/entities/_generated/states/dl/dl_advocate_general.yaml` | merge case_volume |
| `dl_bar_council` | `dl_bar_council` | none | no YAML, skip |
...
| `drp_income_tax` | `drp_income_tax` | none | no YAML, skip |
...
| `enforcement_directorate` | `enforcement_directorate` | none | no YAML, skip |
| `epfat` | `epfat` | none | no YAML, skip |
| `esi_court_generic` | `esi_court_generic` | none | no YAML, skip |
| `family_court_generic` | `family_court_generic` | none | no YAML, skip |
| `governor_state_generic` | `governor_state_generic` | none | no YAML, skip |
| `gram_nyayalaya_generic` | `gram_nyayalaya_generic` | none | YAML added Jun 2026 |
| `gstat` | `gstat` | none | no YAML, skip |
...
| `ibbi` | `ibbi` | none | no YAML, skip |
| `ifsca` | `ifsca` | none | no YAML, skip |
| `iiac` | `iiac` | `data/entities/_generated/backbone/iiac.yaml` | merge case_volume |
| `insurance_ombudsman` | `insurance_ombudsman` | none | no YAML, skip |
...
| `jerc_goa_uts` | `jerc_goa_uts` | none | no YAML, skip |
| `jerc_manipur_mizoram` | `jerc_manipur_mizoram` | none | no YAML, skip |
| `ka_advocate_general` | `ka_advocate_general` | `data/entities/_generated/states/ka/ka_advocate_general.yaml` | merge case_volume |
| `ka_bar_council` | `ka_bar_council` | none | no YAML, skip |
...
| `lokayukta_generic` | `lokayukta_generic` | none | no YAML, skip |
| `lokpal_india` | `lokpal_india` | none | no YAML, skip |
| `mact_generic` | `mact_generic` | none | no YAML, skip |
| `mcia` | `mcia` | `data/entities/_generated/backbone/mcia.yaml` | merge case_volume |
| `mediation_council_india` | `mediation_council_india` | none | YAML added Jun 2026 |
| `meity` | `meity` | none | no YAML, skip |
...
| `ministry_health` | `ministry_health` | none | no YAML, skip |
| `ministry_home_affairs` | `ministry_home_affairs` | none | no YAML, skip |
| `ministry_labour` | `ministry_labour` | none | no YAML, skip |
| `ministry_law_justice` | `ministry_law_justice` | `data/entities/_generated/backbone/ministry_law_justice.yaml` | merge case_volume |
| `ministry_of_communications` | `ministry_of_communications` | none | no YAML, skip |
...
| `ministry_power` | `ministry_power` | none | no YAML, skip |
...
| `ne_lokayuktas_absent` | `ne_lokayuktas_absent` | none | no YAML, skip |
| `ngt` | `ngt` | `data/entities/_generated/backbone/ngt.yaml` | merge case_volume |
| `nic_india` | `nic_india` | none | no YAML, skip |
| `nmc` | `nmc` | none | no YAML, skip |
| `od_rera` | `od_rera` | none | no YAML, skip |
| `parliament_india` | `parliament_india` | none | no YAML, skip |
| `president_india` | `president_india` | `data/entities/_generated/backbone/president_india.yaml` | merge case_volume |
| `public_prosecutor_generic` | `public_prosecutor_generic` | none | no YAML, skip |
...
| `rbi` | `rbi` | none | no YAML, skip |
| `rera_generic` | `rera_generic` | none | no YAML, skip |
| `role_accused` | `role_accused` | none | no YAML, skip |
| `role_advocate` | `role_advocate` | none | no YAML, skip |
| `role_aor` | `role_aor` | none | no YAML, skip |
| `role_cji` | `role_cji` | none | no YAML, skip |
| `role_district_judge` | `role_district_judge` | none | no YAML, skip |
| `role_hc_judge` | `role_hc_judge` | none | no YAML, skip |
| `role_magistrate` | `role_magistrate` | none | no YAML, skip |
| `role_petitioner` | `role_petitioner` | none | no YAML, skip |
| `role_registrar_general` | `role_registrar_general` | none | no YAML, skip |
| `role_respondent` | `role_respondent` | none | no YAML, skip |
| `role_sc_judge` | `role_sc_judge` | none | no YAML, skip |
| `role_senior_advocate` | `role_senior_advocate` | none | no YAML, skip |
| `role_victim` | `role_victim` | none | no YAML, skip |
...
| `serc_generic` | `serc_generic` | none | no YAML, skip |
| `sheriff_hc` | `sheriff_hc` | none | no YAML, skip |
| `slsa_generic` | `slsa_generic` | none | no YAML, skip |
| `solicitor_general_india` | `solicitor_general_india` | none | no YAML, skip |
| `special_court_generic` | `special_court_generic` | none | no YAML, skip |
| `special_pp_generic` | `special_pp_generic` | none | no YAML, skip |
| `state_bar_council_generic` | `state_bar_council_generic` | none | no YAML, skip |
| `state_cdrc_generic` | `state_cdrc_generic` | none | no YAML, skip |
| `state_industrial_tribunal_generic` | `state_industrial_tribunal_generic` | none | no YAML, skip |
| `state_judicial_academy_generic` | `state_judicial_academy_generic` | none | no YAML, skip |
| `state_police_generic` | `state_police_generic` | none | no YAML, skip |
...
- Parked: per-district TN, MH, and KA dashboard metrics. See [`MASTER_CHECKLIST.md`](../../MASTER_CHECKLIST.md) Part 3.5.2.
