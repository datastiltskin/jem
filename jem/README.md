...
**Release:** `v1.0.0` (Jul 2026) — 1,145 entities, 1,835 relationships · summary/detail UI refresh
...
**v1.0.0** (Jul 2026): **1,145** structural entities, **1,835** relationships in `graph.json`. Target: ~1,500 structural entities.
