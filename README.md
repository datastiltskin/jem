...
- Release: `v1.0.0` (Jul 2026). 1,145 entities, 1,835 relationships, 0 orphan nodes (C24/C25 wired Jul 2026). Audit passes 1 to 4 plus the QA sprint (Jun 2026).
...
1,145 of roughly 1,500 structural entities are in the repo (v1.0.0, Jun 2026). Full phased prompts and the maintainer workflow live in [`jem/docs/ENTITY_BUILD_ROADMAP.md`](jem/docs/ENTITY_BUILD_ROADMAP.md).
...
|---|---|
| HC permanent benches + judge strength (allotted/appointed) | Partially in v1.2: bench stubs plus 746 `judge_strength` blocks, only 39 populated. Bulk fill deferred to a maintainer DoJ/HC pass. See the C28 section above. |
